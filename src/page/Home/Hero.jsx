...
            if (index !== currentSlide) return null; // Only render visible image
            return (
              <img
                key={index}
                src={image.src}
...
                className="absolute w-full h-full object-cover rounded-lg cursor-pointer transition-opacity duration-700 ease-in-out opacity-100 z-10"
              />
            );
          })}
